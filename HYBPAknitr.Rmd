...
print(ggarrange(
  ...
  Elo_df_time %>% merge(Performance, by = "Contestant_Name") %>%
    mutate(Appearances_cat = cut(Appearances, 
                               ...
                               right = TRUE, 
                               labels = c("1-5","6-10","11-20","21-40","41-60","61-100","101-250"))) %>% 
    filter(Appearances_cat == "6-10") %>%
    ggplot(aes(x = episode, y = Elo, group = Contestant_Name, colour = Contestant_Name)) + geom_line() + labs(title = "6-10 Appearances", colour = "Contestant")
  ,
  Elo_df_time %>% merge(Performance, by = "Contestant_Name") %>%
    mutate(Appearances_cat = cut(Appearances, 
                               breaks = c(0,5,10,20,40,60,100,250), 
                               right = TRUE, 
                               labels = c("1-5","6-10","11-20","21-40","41-60","61-100","101-250"))) %>% 
    filter(Appearances_cat == "11-20") %>%
    ggplot(aes(x = episode, y = Elo, group = Contestant_Name, colour = Contestant_Name)) + geom_line() + labs(title = "11-20 Appearances", colour = "Contestant")
  ,
  Elo_df_time %>% merge(Performance, by = "Contestant_Name") %>%
    mutate(Appearances_cat = cut(Appearances, 
                               breaks = c(0,5,10,20,40,60,100,250), 
                               right = TRUE, 
                               labels = c("1-5","6-10","11-20","21-40","41-60","61-100","101-250"))) %>% 
    filter(Appearances_cat == "21-40") %>%
    ggplot(aes(x = episode, y = Elo, group = Contestant_Name, colour = Contestant_Name)) + geom_line() + labs(title = "21-40 Appearances", colour = "Contestant")
  ,
  Elo_df_time %>% merge(Performance, by = "Contestant_Name") %>%
    mutate(Appearances_cat = cut(Appearances, 
                               breaks = c(0,5,10,20,40,60,100,250), 
                               right = TRUE, 
                               labels = c("1-5","6-10","11-20","21-40","41-60","61-100","101-250"))) %>% 
    filter(Appearances_cat == "41-60") %>%
    ggplot(aes(x = episode, y = Elo, group = Contestant_Name, colour = Contestant_Name)) + geom_line() + labs(title = "41-60 Appearances", colour = "Contestant")
  ,
  Elo_df_time %>% merge(Performance, by = "Contestant_Name") %>%
    mutate(Appearances_cat = cut(Appearances, 
                               breaks = c(0,5,10,20,40,60,100,250), 
                               right = TRUE, 
                               labels = c("1-5","6-10","11-20","21-40","41-60","61-100","101-250"))) %>% 
    filter(Appearances_cat == "101-250") %>%
...
And how do the different ranking methods at the end of 2021 season compare?
